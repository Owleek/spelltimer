...
import { addShift, removeShift, EDirection } from '../../store/shiftSlice';
...
const CountdownEditor = (props: IProps): JSX.Element => {
    ...
    return (
        <div className={cn('CoundownEditor')}>
            ...
            <HotkeyCell className={'CoundownEditor__leftHotkey'} position={1} onKeyPress={shiftTimeBackward}/>
            <div className="CoundownEditor__iconBox" onClick={shiftTimeBackward}>
            ...
            <div className="CoundownEditor__inputOuter">
                <div className="CoundownEditor__inputBox">
                    <input type="text" className="CoundownEditor__input" value={inputValue} onChange={handleChange} onFocus={handleFocus} onBlur={handleBlur}/>
                </div>
                <span className='CoundownEditor__inputCaption'>sec</span>
            </div>

            <div className="CoundownEditor__iconBox" onClick={shiftTimeForward}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
            ...
            <HotkeyCell className={'CoundownEditor__rigthHotkey'} position={2} onKeyPress={shiftTimeForward}/>
