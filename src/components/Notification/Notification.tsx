                    ...
                    <div className={cn('Notification', {visible})}>
                        <div className="Notification__info">
                            ...
                            {/* <p className="Notification__text">
                                Запуск/приостановка одного из таймеров запускает/приостановливает другие ранее запущенные таймеры.
                                Время в dota 2 течет одинаково для всех спобоностей и предметов.
                            </p> */}
                            <p className="Notification__text">
                                Запуск или приостановка одного из таймеров автоматически применяет это действие ко всем ранее активированным таймерам, 
                                поскольку время перезарядки в Dota 2 синхронизировано для всех способностей и предметов.
                            </p>
                        </div>
                        ...
                        <div className="Notification__actions">
                            <div className="Notification__checkboxContainer">
                                ...
                                <label htmlFor="customCheckbox" className='Notification__checkboxLabel'>Не показывать больше это уведомление</label>
                            </div>
                            <div className="Notification__button" onClick={handleClick}>ок</div>
                        </div>
