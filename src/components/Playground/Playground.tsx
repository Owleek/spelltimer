...
import { ISlot, mapTimerToSlot, removeTimerFromSlot } from '../../store/slotSlice';
...
const Playground = () => {
  ...
  const onSelectAbility = (ability: IDataItem) => {
    ...
    dispatch(mapTimerToSlot(data));
  }

  const removeAbility = (slot: ISlot) => dispatch(removeTimerFromSlot(slot));
  ...
  //       <div className="Playground__slot" key={slot.position}>
  //         {
  //           slot.ability ? 
  //                         <div className="Playground__ability" style={{backgroundImage: `url('${slot.ability?.img}')`}}>
  //                           <span className="Playground__remove" onClick={() => removeAbility(slot)}></span>
  //                         </div>
  //                        : 
  //                         <div className="Playground__emptyContainer" onClick={() => handleClickSlot(slot)}></div>
  //         }
  //       </div>)
  // }
  ...
  //   return slots.map(slot => {
  //     return <div key={slot.position} className="Playground__ability">
  ...
  return (
    <div className="Playground innerContainer">
