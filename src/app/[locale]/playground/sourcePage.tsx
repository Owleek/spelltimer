...
import EmptySlot from '../../../widgets/TimerPanel/TimerBoard/GridSlot/EmptySlot';
...
import Timer from '../../../widgets/TimerPanel/TimerBoard/Timer/Timer';
import LevelController from '../../../widgets/TimerPanel/TimerBoard/LevelController/LevelController';
import LevelControllerView from '../../../widgets/TimerPanel/TimerBoard/LevelController/LevelControllerView';
import SpellReducer from '../../../widgets/TimerPanel/TimerBoard/SpellReducer/SpellReducer';
import BindingOverlay from '../../../shared/ui/BindingOverlay/BindingOverlay';
import CountdownEditor from '../../../widgets/TimerPanel/PanelToolbar/subwidgets/CountdownEditor/sourse';
import Notification from '../../../widgets/Notification/Notification';
import { playSound, SOUND } from '../../../shared/lib/sound';
import ImageCover from '../../../shared/ui/ImageCover/ImageCover';
import { EAppStatus } from '../../../widgets/TimerPanel/types';
        ...
        <div className="Playground__inner">
            ...
            <div className="TimerGear">
                <div className="TimerGear__header">
                    ...
                    <div className={cn('Playground__leftBtnContainer', {hidden: currentStage === EStages.INITIAL})}>
                        {
                            ...
                            <div className={cn('Playground__button')} title={translate('clear_slots')} onClick={reset}>
                        ...
                        }
                        {
                            ...
                            <div className={cn('Playground__button refreshButton')} title={translate('reset_timers')} onClick={handleRefresh}>
                        ...
                        }
                        {
                            ...
                            <div className={cn('Playground__button')} title={translate(withSound ? 'with_sound' : 'without_sound')} onClick={() => handleMute(!withSound)}>
                                {
                                    withSound 
                    ...
                    {
                        currentStage === EStages.EDIT &&
                        <div className={cn('Playground__button play')} onClick={() => changeStage(EStages.PLAY)} title={translate('start_mode')}>
                    ...
                    {
                        currentStage === EStages.PLAY && 
                        <div className={cn('Playground__button')} onClick={() => changeStage(EStages.EDIT)} title={translate('setup_mode')}>
