...
import HotkeyCell from '../../../TimerBoard/HotkeyCell/HotkeyCell';
...
const CountdownEditor = (props: IProps): JSX.Element => {
    ...
    return (
        <div className={cn('CountdownEditor')}>
            ...
            <div className={cn('CountdownEditor__iconBox', {highlight: keyPressed === 1})} onPointerDown={() => handleMouseDown(1)} onPointerUp={() => handleMouseUp(1)} title={translate('time_back')}>
            ...
            <div className={cn('CountdownEditor__iconBox', {highlight: keyPressed === 2})} onPointerDown={() => handleMouseDown(2)} onPointerUp={() => handleMouseUp(2)} title={translate('time_forward')}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
