        ...
        <div className="LevelController appStyledScroll">
            {
                isEdit ?
                   <React.Fragment>
                        <span className={cn('LevelController__btn save', {disabled: !customValue})} onClick={handleSave} title={translate('save')}>
                        ...
                        <div className="LevelController__customisation">
                            <div className="LevelController__customTimeContainer">
                                ...
                                <span className="LevelController__customTimeText">{translate('sec')}</span>
                            </div>
                            <span className={cn('LevelController__btn remove')} onClick={handleRemove} title={translate('cancel_manual_cd')}>
                ...
                :
                    <div className="LevelController__holder">
                        <span className={cn('LevelController__btn edit')} onClick={() => editLevelController(slot.position)} title={translate('manual_cd')}>
