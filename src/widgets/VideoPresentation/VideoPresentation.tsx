        ...
        <div className="VideoPresentation__guideText" onClick={() => setVideoShown(true)}>Как пользоваться ?</div>
        {
            videoShown &&
                <div className="VideoPresentation__videoContainer">
                    <div className="VideoPresentation__videoClose" onClick={() => setVideoShown(false)}>
                    ...
                    <div className="VideoPresentation__outerBox">
                        <div className="VideoPresentation__videoBox">
