...
const Notification = (): JSX.Element => {
    const translate = useTranslations('PlaygroundPage.TimerNotification');
                ...
                createPortal(
                    <div className={cn('Notification', {visible})}>
                        <div className="Notification__info">
                            ...
                            <p className="Notification__text">{translate('notification')}</p>
                        </div>
                        <div className="Notification__actions">
                            <div className="Notification__checkboxContainer">
                                ...
                                <label htmlFor="customCheckbox" className='Notification__checkboxLabel'>{translate('checkbox')}</label>
                            </div>
                            <div className="Notification__button" onClick={handleClick}>{translate('ok')}</div>
                        </div>
