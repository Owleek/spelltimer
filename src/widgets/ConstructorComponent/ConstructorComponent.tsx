...
const Constructor = ({onSelectAbility, onCancel, currentSlot}: IProps) => {
  ...
  const translate = useTranslations('PlaygroundPage.TimerConstructor');
  ...
  return (
    <div className="Constructor">
      ...
      <div className={cn('Sidebar', {absoluteOnMobile: !!itemOwnership})}>
        <div className="Constructor__close" onClick={onCancel} title={translate('close')}>
        ...
        {
          itemOwnership &&
          <div className="Constructor__back" onClick={cancelArtifact} title={translate('cancel')}>
